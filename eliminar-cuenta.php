  ...
  <!-- Nav -->
    <nav id="menu">
      <ul class="links">
        ...
        <li><a href='crearusuario.php'>Registrar</a></li>
      </ul>
    </nav>
    ...
    <?php
      ...
      if ($conexion = mysqli_connect("127.0.0.1","root","")) {
        ...
        $consulta = "DELETE FROM floricultura WHERE dni=$dni03 AND codigodbarra = $code";
        ...
        if (mysqli_query($conexion,$consulta)) {
          ...
          <br></br>
          <ul class='actions'>
            <li><a href='crearusuario.php' class='button special big'>Registrar</a></li>
          </ul>
          <ul class='actions'>
